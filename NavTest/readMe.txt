...
Change Log
2019.01.28 Matsiyan
- /img/gateNetwork.png updated for Eyukua-related systems
- a number of Arcturus and Eyukua sector maps have been added in recent weeks
2018.11.29 Matsiyan
- Corrected dropdown menu bug (thanks starry)
2018.10.18 Matsiyan
...
4) mainMapPos.txt defining the number of pixels in from the left and down from the top of img/gateNetwork.png overview map
